...
if 1:
    ...
    dataset       = EasyDict(tfrecord_dir='streetviewtf')                                                             # Options for load_dataset().
    ...
    # Number of GPUs.
    desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 16#; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}
